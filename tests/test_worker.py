import pytest
from scapy.worker import (
    Worker,
    WorkerData,
    WORKER_TITLE_KEY,
    WORKER_FINGERPRINT_KEY,
    WORKER_CA_URL_KEY,
)

# Require CloudflareAPI.testing.Cloudflare
...
#         dict(
#             name=WORKER_FINGERPRINT_KEY,
#             type="plain_text",
#             text="TEST_FINGERPRINT",
#         ),
...
# def test_worker_data_class_metadata(
#     cloudflare, worker_data, worker_data_metadata_bindings
# ):
#     metadata = worker_data.get_metadata(cloudflare.worker)
#     bindings = metadata.data["bindings"]
#     assert (
#         bindings == worker_data_metadata_bindings
#     ), "Worker.Metadata:binding failed"
